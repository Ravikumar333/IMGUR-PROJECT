...
mongoose.connect('mongodb://127.0.0.1/imageServer', {
  useCreateIndex: true, 
...
// To make uploads folder publically available with '/api/images' route
app.use('/api/images', express.static('media/uploads'));

// Routes
app.use('/api/signIn', require('./routes/signIn'));
app.use('/api/signUp', require('./routes/signUp'));
app.use('/api/upload', checkAuth, require('./routes/upload'));
app.use('/api/imageList', checkAuth, require('./routes/imageList'));
